...
object HBaseBulkLoader {
  ...
  def main(args: Array[String]): Unit = {
    ...
    /*
    args = Array("1", "tbl_logs", "detail", "/user/hive/warehouse/tags_dat.db/tbl_logs", "/datas/output_hfile/tbl_logs")
    args = Array("2", "tbl_goods", "detail", "/user/hive/warehouse/tags_dat.db/tbl_goods", "/datas/output_hfile/tbl_goods")
    args = Array("3", "tbl_users", "detail", "/user/hive/warehouse/tags_dat.db/tbl_users", "/datas/output_hfile/tbl_users")
    args = Array("4", "tbl_orders", "detail", "/user/hive/warehouse/tags_dat.db/tbl_orders", "/datas/output_hfile/tbl_orders")
    */
    if (args.length != 5) {
